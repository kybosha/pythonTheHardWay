#place holder for al of the required text

opening_line = "Let's start with a few questions."

start_text = """A test, a test for the soul while the mind is occupied. Save your soul and your mind may just flicker again, consciousness is a cruel concept. You need a foundation, 
...
wake_text = """As his eyes creaked opened he became aware of the throbbing pain that was present in the back of his head. Reaching back he brushed his fingers across an an egg sized 
...
enter_house_text = """House is entered looks around a bit blah blah blah, on the floor he finds a note written on a post-it note. Not sure where the basement is just yet.  
...
upstairs_text = """He walks up stairs and finds a long straight corridor with 3 rooms, 2 on the left 1 on the right. blah blah blah - does he enter one or head back downstairs?"""
upstairs_hallway_choice_down = "He heads back down the stairs blah blah blah"

	#room1

room1_entry_text = "Blah Blah blah - He enters the first room"

room1_initial_text = """Enters room 1 - turns out to be a bedroom, bedframe with bedside table, wardrobe. What should he inspect?
	"""

room1_bed_text = "Shit about what the bed looks like\n"

	#room2

room2_entry_text = "Blah Blah blah - He enters the second room"

room2_initial_text = """Enters room 2 - it's the bathroom, blah blah blah. There's a shower, a broken toilet bowl and not much else. The light is flickering, the shower is dripping heavily
	turn the shower handle to stop the dripping? 
"""	

room2_no_fix_shower = "The dripping wasn't so bad after all blah blah blah, back to the landing"

	#room3

room3_entry_text = "Blah Blah blah - He enters the third room"

room3_initial_text = """ Third room is a study/office, it is baren except for a desk in front of a large bare window looking out onto the front yard of the house, 
	...
	"""
room3_window_text = """He looks out the window out across the yard...blah blah blah, he can see the outline of the car out towards the tree line reminding him
...
room3_window_desk_text = """Turning his gaze away from the window he looks over the desk, pretty dark so he's not able to see much, tries to open the drawers he finds
			but they are empty. There's an old lamp sitting on the top of the desk, it may still work should he turn it on?"""

room3_desk_text = "Shit about the desk, ask whether to look out the window or leave."

room3_desk_window_text = "He looks out the window out across the yard...blah blah blah then turns and leaves the room."

room3_whisper_text = """He leaves the room, but hears a rustling from the corner of the room making he swing round in fright. There's nothing there so he leaves again, he then 
			hears a whisper \"LAMP\""""
room3_lamp_text = """He turns on the lamp, it fizzes and flickers as it attmepts to illuminate the desk, after a few seconds of flickering it goes full beam blinding him, he shields
...
downstairs_initial_text = """On the ground floor he blah blah blah blah - looks around a little there are 4 rooms, more description about what he sees, he needs to pick a room - A, 
	B, C, or D Or should he go upstairs? Alternatively head back outside?"""

	#rooma

rooma_intial_text = """Enters Room A blah blah blah - it's the kitchen, looks around blah blah blah blah. Description of the kitchen and it's rustic demeanor. Get to the point 
...
rooma_too_fat_text = "You too fat! You dead! blah blah blah monster rips you to pieces"
...
car_text2 = """Blah Blah Blah reach the edge of the wood where what appears to be a dusty track emerges in sight, just as you reach it a blinding light fills looms forth
